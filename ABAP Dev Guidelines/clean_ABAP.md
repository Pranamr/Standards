...
This guide is largely based on [SAP Clean ABAP styleguide](https://github.com/SAP/styleguides/blob/main/clean-abap/CleanABAP.md) with some organization-specific addenda.
...
- [Tables](#tables)
  ...
  - [Avoid Nested Loops](#avoid-nested-loops) 
  - [Usage of Field Symbols](#usage-of-field-symbols)  
- [Strings](#strings)
...
- [Booleans](#booleans)
  ...
  - [Consider using timestamp instead of Boolean](#consider-using-timestamp-instead-of-boolean)
...
- [Macros](#macros)
  - [Prohibition of the Usage of Macros](#prohibition-of-the-usage-of-macros)
- [Data Dictionary](#data-dictionary)
  - [Defining Custom Tables](#defining-custom-tables)
    - [Use Check Tables](#use-check-tables)
    - [Use Search Helps](#use-search-helps) 
...
- [Formatting](#formatting)
  ...
  - [Remove unused program parts](#unused-program-parts)
  - [Add Header to Source Code](#header-to-source-code)
- [Testing](#testing)
...
### Avoid Nested Loops
> [Clean ABAP](#clean-abap) > [Content](#content) > [Tables](#tables) > [This section](#avoid-nested-loops)

As far as possible nested loops in coding should be avoided, since they have a negative effect on the performance. However, there are circumstances under which they cannot be avoided. ( this in fact happens often ) . If they are unavoidable, the parallel cursor technique should be used to improve operations on such internal tables. 

### Usage of Field Symbols
> [Clean ABAP](#clean-abap) > [Content](#content) > [Tables](#tables) > [This section](#usage-of-field-symbols)

Field Symbols should be used for looping through large internal tables. This helps to improve performance when compared to the usage of work areas. 
...
### Consider using timestamp instead of Boolean

> [Clean ABAP](#clean-abap) > [Content](#content) > [Booleans](#booleans) > [This section](#consider-using-timestamp-instead-of-boolean)

Using a timestamp instead of a Boolean gives additional time information on top of the simple binary-state information, which may be more useful in some cases.

Read further in [this article](https://www.mensurdurakovic.com/three-reasons-why-you-should-store-timestamp-instead-of-boolean/).
...
> [Clean ABAP](#clean-abap) > [Content](#content) > [Formatting](#formatting) > [This section](#unused-program-parts)

Remove any program parts that are not used. Such coding is also referred to as dead code - or in other words coding that would never get executed. This helps to reduce noise and clutter in the Application and keeps everything clean. 

### Add Header to Source Code
> [Clean ABAP](#clean-abap) > [Content](#content) > [Formatting](#formatting) > [This section](#header-to-source-code)

Headers at the top of a piece of source code provide valuable information that can be accessed quickly by the reader to determine handy information such as who developed it, why was it developed, when was it developed etc. 
However, it can also tend to provide information that is redundant and not really needed. For eg. transport requests. 
Hence the Header being proposed for the SHAPE+ Project is one offering just the necessary information without being too lengthy . 

The current version of the Header can be found at
https://confluence.dhl.com/display/SPLUS/I+Documentation+of+Source+Code
